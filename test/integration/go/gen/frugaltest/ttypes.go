...
//  - ImFalse
type Bools struct {
	ImTrue  bool `thrift:"im_true,1" db:"im_true" json:"im_true"`
	ImFalse bool `thrift:"im_false,2" db:"im_false" json:"im_false"`
}
...
//  - I64Thing
type Xtruct struct {
	StringThing string `thrift:"string_thing,1" db:"string_thing" json:"string_thing"`
	// unused fields # 2 to 3
	ByteThing int8 `thrift:"byte_thing,4" db:"byte_thing" json:"byte_thing"`
	// unused fields # 5 to 8
	I32Thing int32 `thrift:"i32_thing,9" db:"i32_thing" json:"i32_thing"`
	// unused field # 10
	I64Thing int64 `thrift:"i64_thing,11" db:"i64_thing" json:"i64_thing"`
}
...
//  - I32Thing
type Xtruct2 struct {
	ByteThing   int8    `thrift:"byte_thing,1" db:"byte_thing" json:"byte_thing"`
	StructThing *Xtruct `thrift:"struct_thing,2" db:"struct_thing" json:"struct_thing"`
	I32Thing    int32   `thrift:"i32_thing,3" db:"i32_thing" json:"i32_thing"`
}
...
type Xtruct3 struct {
	StringThing string `thrift:"string_thing,1" db:"string_thing" json:"string_thing"`
	// unused fields # 2 to 3
	Changed int32 `thrift:"changed,4" db:"changed" json:"changed"`
	// unused fields # 5 to 8
	I32Thing int32 `thrift:"i32_thing,9" db:"i32_thing" json:"i32_thing"`
	// unused field # 10
	I64Thing int64 `thrift:"i64_thing,11" db:"i64_thing" json:"i64_thing"`
...
type Insanity struct {
	UserMap map[Numberz]UserId `thrift:"userMap,1" db:"userMap" json:"userMap"`
	Xtructs []*Xtruct          `thrift:"xtructs,2" db:"xtructs" json:"xtructs"`
}
...
type OneField struct {
	Field *EmptyStruct `thrift:"field,1" db:"field" json:"field"`
}
...
type VersioningTestV1 struct {
	BeginInBoth int32 `thrift:"begin_in_both,1" db:"begin_in_both" json:"begin_in_both"`
	// unused field # 2
	OldString string `thrift:"old_string,3" db:"old_string" json:"old_string"`
	// unused fields # 4 to 11
	EndInBoth int32 `thrift:"end_in_both,12" db:"end_in_both" json:"end_in_both"`
}
...
type VersioningTestV2 struct {
	BeginInBoth int32           `thrift:"begin_in_both,1" db:"begin_in_both" json:"begin_in_both"`
	Newint_     int32           `thrift:"newint,2" db:"newint" json:"newint"`
	Newbyte_    int8            `thrift:"newbyte,3" db:"newbyte" json:"newbyte"`
	Newshort_   int16           `thrift:"newshort,4" db:"newshort" json:"newshort"`
	Newlong_    int64           `thrift:"newlong,5" db:"newlong" json:"newlong"`
	Newdouble_  float64         `thrift:"newdouble,6" db:"newdouble" json:"newdouble"`
	Newstruct_  *Bonk           `thrift:"newstruct,7" db:"newstruct" json:"newstruct"`
	Newlist_    []int32         `thrift:"newlist,8" db:"newlist" json:"newlist"`
	Newset_     map[int32]bool  `thrift:"newset,9" db:"newset" json:"newset"`
	Newmap_     map[int32]int32 `thrift:"newmap,10" db:"newmap" json:"newmap"`
	Newstring_  string          `thrift:"newstring,11" db:"newstring" json:"newstring"`
	EndInBoth   int32           `thrift:"end_in_both,12" db:"end_in_both" json:"end_in_both"`
}
...
func (p *VersioningTestV2) ReadField8(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Newlist_ = append(p.Newlist_, _elem3)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
type ListTypeVersioningV1 struct {
	Myints []int32 `thrift:"myints,1" db:"myints" json:"myints"`
	Hello  string  `thrift:"hello,2" db:"hello" json:"hello"`
}
...
func (p *ListTypeVersioningV1) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Myints = append(p.Myints, _elem7)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
type ListTypeVersioningV2 struct {
	Strings []string `thrift:"strings,1" db:"strings" json:"strings"`
	Hello   string   `thrift:"hello,2" db:"hello" json:"hello"`
}
...
func (p *ListTypeVersioningV2) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Strings = append(p.Strings, _elem8)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
type GuessProtocolStruct struct {
	...
	MapField map[string]string `thrift:"map_field,7" db:"map_field" json:"map_field"`
}
...
type LargeDeltas struct {
	B1 *Bools `thrift:"b1,1" db:"b1" json:"b1"`
	// unused fields # 2 to 9
	B10 *Bools `thrift:"b10,10" db:"b10" json:"b10"`
	// unused fields # 11 to 99
	B100 *Bools `thrift:"b100,100" db:"b100" json:"b100"`
	// unused fields # 101 to 499
	CheckTrue bool `thrift:"check_true,500" db:"check_true" json:"check_true"`
	// unused fields # 501 to 999
	B1000 *Bools `thrift:"b1000,1000" db:"b1000" json:"b1000"`
	// unused fields # 1001 to 1499
	CheckFalse bool `thrift:"check_false,1500" db:"check_false" json:"check_false"`
	// unused fields # 1501 to 1999
	Vertwo2000 *VersioningTestV2 `thrift:"vertwo2000,2000" db:"vertwo2000" json:"vertwo2000"`
	// unused fields # 2001 to 2499
	ASet2500 map[string]bool `thrift:"a_set2500,2500" db:"a_set2500" json:"a_set2500"`
	// unused fields # 2501 to 2999
	Vertwo3000 *VersioningTestV2 `thrift:"vertwo3000,3000" db:"vertwo3000" json:"vertwo3000"`
	// unused fields # 3001 to 3999
	BigNumbers []int32 `thrift:"big_numbers,4000" db:"big_numbers" json:"big_numbers"`
}
...
func (p *LargeDeltas) ReadField4000(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.BigNumbers = append(p.BigNumbers, _elem12)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
type NestedListsI32x2 struct {
	Integerlist [][]int32 `thrift:"integerlist,1" db:"integerlist" json:"integerlist"`
}
...
func (p *NestedListsI32x2) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Integerlist = append(p.Integerlist, _elem13)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *NestedListsI32x3) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Integerlist = append(p.Integerlist, _elem15)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
type NestedMixedx2 struct {
	IntSetList       []map[int32]bool            `thrift:"int_set_list,1" db:"int_set_list" json:"int_set_list"`
	MapIntStrset     map[int32]map[string]bool   `thrift:"map_int_strset,2" db:"map_int_strset" json:"map_int_strset"`
	MapIntStrsetList []map[int32]map[string]bool `thrift:"map_int_strset_list,3" db:"map_int_strset_list" json:"map_int_strset_list"`
}
...
func (p *NestedMixedx2) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		for i := 0; i < size; i++ {
			...
			_elem18[_elem19] = true
		}
		if err := iprot.ReadSetEnd(); err != nil {
			return thrift.PrependError("error reading set end: ", err)
		}
		p.IntSetList = append(p.IntSetList, _elem18)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
func (p *NestedMixedx2) ReadField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		for i := 0; i < size; i++ {
			...
			_elem23[_key24] = _val25
		}
		if err := iprot.ReadMapEnd(); err != nil {
			return thrift.PrependError("error reading map end: ", err)
		}
		p.MapIntStrsetList = append(p.MapIntStrsetList, _elem23)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return thrift.PrependError("error reading list end: ", err)
	}
...
type ListBonks struct {
	Bonk []*Bonk `thrift:"bonk,1" db:"bonk" json:"bonk"`
}
