...
func TestBreakingChanges(t *testing.T) {
	expected := []string{
		...
		"struct test_struct2: field struct2_member4: types not equal: double -> i16",
		...
		"service derived1: method derived1_function1: types not equal: test_enum1 -> test_enum2",
		"service derived1: method derived1_function6: types not equal: test_struct1 -> test_struct2",
		"service derived1: method derived1_function4: types not equal: string -> double",
		...
		"service base: method base_function2: field function2_arg8: types not equal: test_enum1 -> test_enum3",
		...
		"service derived1: method derived1_function6: types not equal: test_struct1 -> map",
