...
func TestBreakingChanges(t *testing.T) {
	expected := []string{
		...
		"service derived2: method derived2_function1: return type: types not equal: 'i32' -> 'i16'",
		"service derived2: method derived2_function5: return type: types not equal: 'test_enum1' -> 'test_enum3'",
		"service derived2: method derived2_function6: return type: types not equal: 'test_struct2' -> 'test_struct3'",
