...
public class EventsPublisher {
	...
	public interface Iface {
		...
		public void publishEventCreated(FContext ctx, String preamble, String ramble, String role, String RID, Event req) throws TException;
	...
	public static class Client implements Iface {
		...
		public void publishEventCreated(FContext ctx, String preamble, String ramble, String role, String RID, Event req) throws TException {
			proxy.publishEventCreated(ctx, preamble, ramble, role, RID, req);
		}
