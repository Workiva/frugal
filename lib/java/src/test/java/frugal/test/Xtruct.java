...
public class Xtruct implements org.apache.thrift.TBase<Xtruct, Xtruct._Fields>, java.io.Serializable, Cloneable, Comparable<Xtruct> {
	...
	public boolean equals(Xtruct that) {
		if (that == null)
			return false;
		if (!Objects.equals(this.string_thing, that.string_thing))
			return false;
	...
	public int compareTo(Xtruct other) {
		...
		lastComparison = Boolean.compare(isSetString_thing(), other.isSetString_thing());
		if (lastComparison != 0) {
		...
		lastComparison = Boolean.compare(isSetI64_thing(), other.isSetI64_thing());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetI64_thing()) {
	...
	public void read(org.apache.thrift.protocol.TProtocol iprot) throws org.apache.thrift.TException {
		...
		new XtructStandardScheme().read(iprot, this);
	}
	...
	public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
		...
		new XtructStandardScheme().write(oprot, this);
	}
