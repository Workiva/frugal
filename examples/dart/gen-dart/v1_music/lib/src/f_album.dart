...
class Album implements thrift.TBase {
  ...
  static final thrift.TField _TRACKS_FIELD_DESC =
      thrift.TField('tracks', thrift.TType.LIST, 1);
  static final thrift.TField _DURATION_FIELD_DESC =
      thrift.TField('duration', thrift.TType.DOUBLE, 2);
  static final thrift.TField _ASIN_FIELD_DESC =
      thrift.TField('ASIN', thrift.TType.STRING, 3);
  ...
  write(thrift.TProtocol oprot) {
    ...
    if (this.tracks != null) {
      ...
      oprot.writeListBegin(
          thrift.TList(thrift.TType.STRUCT, this.tracks!.length));
