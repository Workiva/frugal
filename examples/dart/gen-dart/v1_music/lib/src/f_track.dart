...
class Track implements thrift.TBase {
  ...
  static final thrift.TField _TITLE_FIELD_DESC =
      thrift.TField('title', thrift.TType.STRING, 1);
  static final thrift.TField _ARTIST_FIELD_DESC =
      thrift.TField('artist', thrift.TType.STRING, 2);
  static final thrift.TField _PUBLISHER_FIELD_DESC =
      thrift.TField('publisher', thrift.TType.STRING, 3);
  static final thrift.TField _COMPOSER_FIELD_DESC =
      thrift.TField('composer', thrift.TType.STRING, 4);
  static final thrift.TField _DURATION_FIELD_DESC =
      thrift.TField('duration', thrift.TType.DOUBLE, 5);
  static final thrift.TField _PRO_FIELD_DESC =
      thrift.TField('pro', thrift.TType.I32, 6);
  ...
  validate() {
    ...
    if (isSetPro() &&
        !t_v1_music.PerfRightsOrg.VALID_VALUES.contains(this.pro)) {
      throw thrift.TProtocolError(thrift.TProtocolErrorType.INVALID_DATA,
          "The field 'pro' has been assigned the invalid value ${this.pro}");
    }
  }
}
